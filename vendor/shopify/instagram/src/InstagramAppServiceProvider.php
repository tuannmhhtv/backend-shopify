...
class InstagramAppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom( resource_path('views/vendor/instagram/base'), config('shopify.instagram.prefix') );
        // - then the stock views that come with the package, in case a published view might be missing
        $this->loadViewsFrom( realpath(__DIR__.'/resources/views'), config('shopify.instagram.prefix') );
